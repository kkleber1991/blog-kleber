...
@section('main')
<section class="px-2 py-8 bg-white lg:py-20 md:px-0 dark:bg-[#232323]">
        ...
        <div class="flex flex-wrap items-center sm:-mx-3">
            <div class="w-full md:w-1/2 md:px-3">
                <div class="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 sm:pr-5 lg:pr-0 md:pb-0">
                    <h1 class="text-4xl font-extrabold tracking-tight sm:text-5xl md:text-4xl lg:text-5xl">
                    ...
                    <div class="relative flex flex-col sm:flex-row sm:space-x-4">
                        <a href="https://github.com/kkleber1991/blog-kleber" class="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-purple-600 rounded-md sm:mb-0 hover:bg-indigo-700 sm:w-auto">
                            Veja no Github
                        </a>
                    </div>
                </div>
...
<section class="container mx-auto bg-[#181818] rounded-md text-center">
...
<section class="container mx-auto bg-[#181818] rounded-md">
